...
#ifdef __linux__
#define BOT_VER "TF2/HL2DM/DOD:S 1.04 META Linux 491-apg (merge) (BUILD " __DATE__ "-" __TIME__ ")" //bir3yk
#else
#define BOT_VER "TF2/HL2DM/DOD:S 1.04 META Win32 491-apg (merge) (BUILD " ## __DATE__ ## "-" ## __TIME__ ## ")"
#endif
