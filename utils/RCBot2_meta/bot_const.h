...
#ifdef __linux__
#define BOT_VER "TF2/HL2DM/DOD:S 1.00 META Linux 475-apg (BUILD " __DATE__ "-" __TIME__ ")" //bir3yk
#else
#define BOT_VER "TF2/HL2DM/DOD:S 1.00 META Win32 475-apg (BUILD " ## __DATE__ ## "-" ## __TIME__ ## ")"
#endif
